...
```
git clone git@github.com:your-username/phonegap-plugin-image-capture.git
```
...
git remote add upstream https://github.com/phonegap/phonegap-plugin-image-capture.git
```
